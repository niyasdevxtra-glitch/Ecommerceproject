export function initFluid(canvas) {
    ...
    // Attach events using canvas instead of window for non-global scope
    canvas.addEventListener('mousedown', handleMouseDown);
    window.addEventListener('mousemove', handleMouseMove); // mousemove can stay window for smoother tracking
